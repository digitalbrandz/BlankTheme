                            ...
                            return a.a.wrap(function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        ...
                                        this.checkoutForm.querySelector('.multiselect_wrap') ? { line_items: Array.from(this.checkoutForm.querySelectorAll('[name="id"]:checked')).map(x => ({variant_id:x.value, quantity: x.getAttribute('quantity')})) } : {line_items: [c]}, t.abrupt("return", u);
                                    case 11:
                                    case "end":
                                        return t.stop()
                                }
